defmodule ExamsWeb.Router do
  ...
  scope "/api", ExamsWeb do
    ...
    resources "/templates", ExamTemplateController,
      only: [:show, :index, :create, :delete, :update]

    resources "/questions", ExamTemplateQuestionController,
      only: [:show, :index, :create, :delete, :update]

    resources "/answers", ExamTemplateAnswerController,
      only: [:show, :index, :create, :delete, :update]

    resources "/exams", ExamTestsController, only: [:show, :index, :create, :delete, :update]
  end

  forward "/graph", Absinthe.Plug, schema: ExamsWeb.Schema

  forward "/graphiql", Absinthe.Plug.GraphiQL, schema: ExamsWeb.Schema
end
